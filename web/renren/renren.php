...
class Renren {
	...
	function set_session_key($session_key){
...
class Renren_API_Client {
	...
	function notifications_sendemail($recipients, $template_id, $recipients, $template_data) {
		return $this->_call_method('notifications.sendEmail', array( 'recipients'=> $recipients,
