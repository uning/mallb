...
function install_swf(pid){
	...
	flashvars.pconf = '../static/flash/test_0_mall_config.xml';
	//flashvars.pconf = '<?php echo urlencode('http://192.168.1.50/work/mall/backend/web/renren/test_config_xml.php');?>';
	flashvars.languagetype = "0";
	flashvars.STAGE_WIDTH = "800";
	flashvars.CRITICAL_ERROR_SHOW = "1";
