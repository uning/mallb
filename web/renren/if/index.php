...
function install_swf(pid){
	...
	flashvars.CHECK_DUP = 1;	
 
	flashvars.CLEAR_CACHE_URL="http://group.renren.com/GetThread.do?id=331584998&parentpage=&curpage=0&label=&tribeId=336701942";
...
<div id="header">
	<div class='topbar'>  
			<ul id="scrollBox">   
				  ...
				  <li> 货物卖完了，记得及时上货哦。多上货才能多赚钱 </li>  
				   <li> <a href='http://page.renren.com/pa/bf?pid=699110107'>关注应用主页，及时了解最新最酷最炫功能更新</a> </li>  
				  <li> 欢迎大家加QQ群： 116299965, 120817224(满) </li>
				  <li><span>升级的时候，别忘了分享金币给大家哦，这个金币是系统奖给好友的。</span></li>
	...
	<div class="topad" style='width:100%'>
		<a target='_blank' href='http://page.renren.com/699110107/note/489040621?&ref=minifeed&sfet=2003&fin=0&feed=user_blogshare'>
			<img src="<?php echo RenrenConfig::$resource_urlp;?>images/cinemar_banner.png">
		</a>
	</div>
	...
	src="../static/images/loading.gif"/></div>
		...
		<div class="help">
			    <span style="width: 625px; float: left;">
					[<a href='http://group.renren.com/GetThread.do?id=331584998&parentpage=&curpage=0&label=&tribeId=336701942' target='_blank'>如何清除浏览器缓存</a>]&nbsp;&nbsp;[<a href='http://group.renren.com/GetThread.do?id=331592923&parentpage=0&curpage=0&label=&tribeId=336701942' target='_blank'>更新公告</a>]&nbsp;&nbsp;[<a href='http://page.renren.com/pa/bf?pid=699110107' target='_blank'>关注我们</a>]&nbsp;&nbsp;[QQ群：116299965]
		...
		<div class='bottom'>
			<a target='_blank' href='http://page.renren.com/pa/bf?pid=699110107'>
...
function send_notification0914()
{	
	
	$.get("../ajax/get_users_0914.php" ,{}, function(data){
 		var to_ids = data ; 
		var notification = "购物天堂中秋活动送48宝石的电影院: <a href='http://apps.renren.com/livemall?f=noti_0914'> >>快来领取自己的电影院并帮助好友开启</a>";;
 		XN.Main.get_sessionState().waitUntilReady(function(){
 			XN.Main.apiClient.notifications_send(to_ids, notification,function(result, ex){
					$.post("../ajax/update_users_0914.php", {'to_ids':to_ids});
				}
			);
	    ...
	    //	  console.log('index after_fbinit');
	    	   pid = PL.conf('pid')||query_json.xn_sig_user;
	  		   ...
	  		   if(!pid){
				  ...
				  <?php if(!$sess['notification0914'] ){
						    echo "send_notification0914();";
						    $sess['notification0914'] =  1;
						    TTGenid::save($sess); 
						}else if($sess['notification0914'] === 1) {
						   echo "send_notification0914();";
