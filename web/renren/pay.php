...
.pay-type li .paypay{
	background:url("<?php echo RenrenConfig::$resource_urlp ?>/images/payment1.png") no-repeat scroll center top transparent;
	height:210px;
}
.pay-type li input {
background:url("<?php echo RenrenConfig::$resource_urlp ?>/images/payment1.png") no-repeat scroll center top transparent;
    ...
    <div class='container'>
        <div class='canvas'>
		    ...
		    <div id='pay-body'>
				...
				<div class='pay-tab'> 
						<ul style="clear:both;">
						     <li class="current"><a href="#nogo"  >充值宝石</a></li>
						     <li><a target="_top" href="<?php echo RenrenConfig::$canvas_url;?>pay_history.php?f=pay">充值记录</a></li>
					...
					<ul class="pay-type clearfix">
						<li>
							<div class='paypay gem-10-50'>
								...
								<div class='gem-num'>
									<img  id='gem-num-img-5'  src='<?php echo RenrenConfig::$resource_urlp; ?>/images/gem_50.png' />
									<img id='gem-num-img-4' style='display:none' src='<?php echo RenrenConfig::$resource_urlp; ?>/images/gem_40.png' />
									<img id='gem-num-img-3' style='display:none' src='<?php echo RenrenConfig::$resource_urlp; ?>/images/gem_30.png' />
									<img id='gem-num-img-2' style='display:none'  src='<?php echo RenrenConfig::$resource_urlp; ?>/images/gem_20.png' /> 
